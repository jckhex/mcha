...
a.info:hover span{   display:block;   position:absolute;   top:2em; left:-10em; width:45em;   border:1px solid #0cf;  background-color:#FEE2AB; color:#000;    text-align: left}
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><i class="fa fa-angle-double-down"></i>DTH Recharge
</h1>  
                </div>
                <!-- /.col-lg-12 -->
            </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                      ...
                      <table width="50%" align="center" class="td_box">
                        <tbody><tr>
                          <td colspan="2"><b>Recharge Your DTH </b></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td>
 						  <select name="opt_code" id="opt_code" style="width:200px; height:30px; border:1px solid #d4d4d4; margin-bottom:2px;" onChange="do_get_operator_plan_details();"><option value="">Select Your Operator</option><option value="ADTH">Airtel Digital TV</option><option value="DDTH">Dish TV</option><option value="BDTH">RELIANCE BIG TV</option><option value="SDTH">Sun Direct</option><option value="TDTH">TATA SKY</option><option value="VDTH">Videocon d2h</option></select> 
                           </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td align="center">&nbsp;</td>
                          <td align="left"><input type="hidden" name="opt_type" value="DTH">
