...
include('sidebar.php'); ?> 
    ...
    <div class="row fleet-content">  
         ...
         <form id="form1" name="form1" method="get" action="http://paylife.in/userpanel/direct_level_tree.php">
              <input type="hidden" name="current_id" value="3397">
              <br><br>
              <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                     ...
                     <tbody><tr>
                        ...
                        <td align="center" valign="top">
				           ...
				           <table width="400" border="0" align="center" cellpadding="4" cellspacing="4">
                               <tbody>
                                     <tr>
                                        <td width="50%" align="center" class="maintxt"><strong>User ID : </strong><?php echo $abc['username']?></td>
                                     </tr>
                                      <tr>
                                        <td width="50%" align="center" class="maintxt"><strong> Name : </strong><?php echo $abc['full_name']?></td>
                                     </tr>
                               </tbody>
                           </table>
                               <br> 
                        ...
                        <td align="center" valign="top"><div class="error"></div>
                              <table border="0" align="center" cellpadding="2" cellspacing="2" class="table">
                                  <tbody>
                                      <tr>
                                         <td align="center" class="maintxt"><input name="q" type="text" value=""></td>
                                      </tr>
                                      <tr>
                ...
                <tr>
				  ...
				  <table border="0" align="center" cellpadding="0" cellspacing="0">
                      <tbody>
                             <tr>
                                <td align="center" colspan="7"><div class="smalltxt" align="center"><strong><?php echo $abc['username']?></strong> </div>
                                          <a class="info" href="http://paylife.in/userpanel/direct_level_tree.php">
                      ...
                      <tr>
                        <td colspan="7" align="center"><img src="./Bolindia.biz_files/tree_arrow.gif" width="540">&nbsp;&nbsp;&nbsp;</td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td width="242" align="center">
                                               ...
                                               <?php
									                $schid=$_SESSION['reg_id'];
												  $sql= mysqli_query($conn ,"select * from tbl_paylife_registartion where   sponsor_id='$schid' && leg_id='A'   "); 
												         while($abc=mysqli_fetch_array($sql))           
														{
														?>
                        
                        
                        <div class="smalltxt" align="center"><strong><?php echo $abc['username']?></strong></div>
                                                   <a class="info" href="http://paylife.in/userpanel/direct_level_tree.php?u_id=3395">
                                                    <img src="./Bolindia.biz_files/tree_red.png" align="middle" border="0" onMouseOver="do_get_downline_details(sponsor_id);">
                                      <span class="smalltxt">
	                  ...
	                  <table width="100%" border="1" cellspacing="3" cellpadding="3" class=" ">
                        ...
                        <td width="243" align="center">
                                                    <?php
									                $schid=$_SESSION['reg_id'];
												  $sql= mysqli_query($conn ,"select * from tbl_paylife_registartion where   sponsor_id='$schid' && leg_id='B'   "); 
												         while($abc=mysqli_fetch_array($sql))           
														{
														?>
                        ...
                        <div class="smalltxt" align="center"> <strong><?php echo $abc['username']?></strong> </div>
                                                  <a class="info" href="http://paylife.in/userpanel/direct_level_tree.php?u_id=3397">
                                                    <img src="./Bolindia.biz_files/tree_red.png" align="middle" border="0" onMouseOver="do_get_downline_details(sponsor_id);">
                                               <span class="smalltxt">
                                                      <div align="center" id="3397" class="error">
                    ...
                    <td width="222" align="center">
                                                            <?php
									                $schid=$_SESSION['reg_id'];
												  $sql= mysqli_query($conn ,"select * from tbl_paylife_registartion where   sponsor_id='$schid' && leg_id='C'   "); 
												         while($abc=mysqli_fetch_array($sql))           
														{
														?>
                    
                                            <div class="smalltxt" align="center"><strong><?php echo $abc['username']?></strong></div>
                                                     <a class="info" href="http://paylife.in/userpanel/direct_level_tree.php?u_id=3398">
                                                    <img src="./Bolindia.biz_files/tree_red.png" align="middle" border="0" onMouseOver="do_get_downline_details(sponsor_id);">
                                          <span class="smalltxt">
                                                 <div align="center" id="3398" class="error">
	                         <table width="100%" border="1" cellspacing="3" cellpadding="3" class=" ">
                                    <tbody>
                                          <tr class="tdOdd">
                                                 <td width="25%" align="right" class="maintxt"> <strong>Name :</strong></td>
                               ...
                               <table width="93%" border="0" align="center" cellpadding="1" cellspacing="0">
                                  <tbody><tr>
                                              ...
                                              <td width="-1"></td>
                                               <?php
									$schid=$_SESSION['reg_id'];
	$sql= mysqli_query($conn ,"select *  from tbl_paylife_registartion where sponsor_id in (select reg_id from tbl_paylife_registartion where sponsor_id='$schid') && leg_id='A' ");
								while($abc=mysqli_fetch_array($sql)) {?>   
                                              <td width="50" align="center"><div class="smalltxt" align="center"><strong><?php echo $abc['username']?></strong> </div>
                                            <a class="info" href="http://paylife.in/userpanel/direct_level_tree.php?u_id=3398">
                                                    <img src="./Bolindia.biz_files/tree_red.png" align="middle" border="0" onMouseOver="do_get_downline_details(sponsor_id);">
                                          <span class="smalltxt">
                                                 <div align="center" id="3398" class="error">
	                         <table width="100%" border="1" cellspacing="3" cellpadding="3" class=" ">
                                    <tbody>
                                          <tr class="tdOdd">
                                                ...
                                                <td align="right" class="maintxt"><strong>Total ID  :</strong></td>
                                                <td align="left" class="maintxt"><?php
                                                                  $cntct_select="select count(*)  from tbl_paylife_registartion where sponsor_id in (select reg_id from tbl_paylife_registartion where sponsor_id='$schid') ";
																						$a13=mysqli_query($conn,$cntct_select); 
																						if($a13){ while($g=mysqli_fetch_array($a13)){
																						     echo $g[0]."<br>";}}else 
																							{echo "error";}?> </td>
                                              ...
                                              <td width="29"></td>
                                               <?php
									$schid=$_SESSION['reg_id'];
	$sql= mysqli_query($conn ,"select *  from tbl_paylife_registartion where sponsor_id in (select reg_id from tbl_paylife_registartion where sponsor_id='$schid') && leg_id='B' ");
								while($abc=mysqli_fetch_array($sql)) {?> 
                                              <td width="55" align="right"><div class="smalltxt" align="right"> <strong><?php echo $abc['username']?></strong> </div>
                                              <a class="info" href="http://paylife.in/userpanel/direct_level_tree.php?u_id=3398">
                                                    <img src="./Bolindia.biz_files/tree_red.png" align="middle" border="0" onMouseOver="do_get_downline_details(sponsor_id);">
                                          <span class="smalltxt">
                                                 <div align="center" id="3398" class="error">
                                    ...
                                    <tbody>
                                          <tr class="tdOdd">
                                              ...
                                              <td width="27"></td>
                                               <?php
									$schid=$_SESSION['reg_id'];
	$sql= mysqli_query($conn ,"select *  from tbl_paylife_registartion where sponsor_id in (select reg_id from tbl_paylife_registartion where sponsor_id='$schid') && leg_id='C' ");
								while($abc=mysqli_fetch_array($sql)) {?> 
                                              <td width="50" align="right"> <div class="smalltxt" align="right"> <strong><?php echo $abc['username']?></strong> </div>
                                              <a class="info" href="http://paylife.in/userpanel/direct_level_tree.php?u_id=3398">
                                                    <img src="./Bolindia.biz_files/tree_red.png" align="middle" border="0" onMouseOver="do_get_downline_details(sponsor_id);">
                                          <span class="smalltxt">
                                                 <div align="center" id="3398" class="error">
	...
	$sql= mysqli_query($conn ,"select *  from tbl_paylife_registartion where sponsor_id in (select reg_id from tbl_paylife_registartion where sponsor_id='$schid') && leg_id='A' ");
								while($abc=mysqli_fetch_array($sql)) {?>  
                                         <td width="95" align="center"><div class="smalltxt" align="center"> <strong><?php echo $abc['username']?></strong> </div>
                                         <a class="info" href="http://paylife.in/userpanel/direct_level_tree.php?u_id=3398">
                                                    <img src="./Bolindia.biz_files/tree_red.png" align="middle" border="0" onMouseOver="do_get_downline_details(sponsor_id);">
                                          <span class="smalltxt">
                                                 <div align="center" id="3398" class="error">
	...
	$sql= mysqli_query($conn ,"select *  from tbl_paylife_registartion where sponsor_id in (select reg_id from tbl_paylife_registartion where sponsor_id='$schid') && leg_id='B' ");
								while($abc=mysqli_fetch_array($sql)) {?>  
                                          <td width="83" align="right"><div class="smalltxt" align="right"> <strong><?php echo $abc['username']?></strong> </div>
                                           <a class="info" href="http://paylife.in/userpanel/direct_level_tree.php?u_id=3398">
                                                    <img src="./Bolindia.biz_files/tree_red.png" align="middle" border="0" onMouseOver="do_get_downline_details(sponsor_id);">
                                          <span class="smalltxt">
                                                 <div align="center" id="3398" class="error">
	...
	$sql= mysqli_query($conn ,"select *  from tbl_paylife_registartion where sponsor_id in (select reg_id from tbl_paylife_registartion where sponsor_id='$schid') && leg_id='C' ");
								while($abc=mysqli_fetch_array($sql)) {?>  
                                          <td width="48" align="right"><div class="smalltxt" align="right"> <strong><?php echo $abc['username']?></strong> </div>
                                           <a class="info" href="http://paylife.in/userpanel/direct_level_tree.php?u_id=3398">
                                                    <img src="./Bolindia.biz_files/tree_red.png" align="middle" border="0" onMouseOver="do_get_downline_details(sponsor_id);">
                                          <span class="smalltxt">
                                                 <div align="center" id="3398" class="error">
	...
	$sql= mysqli_query($conn ,"select *  from tbl_paylife_registartion where sponsor_id in (select reg_id from tbl_paylife_registartion where sponsor_id='$schid') && leg_id='C' ");
                    ...
                    <br></td>
                            ...
                            <p style="padding-left:300px;font-size:16px; ">
                                Next Page:
				 <a href="http://paylife.in/userpanel/direct_level_tree.php" style="padding-left:3px;color:#FF0000">1</a>
                                              </p>
            </form>
